...
import com.applozic.mobicomkit.uiwidgets.Retrofit.ServiceGenerator;
...
abstract public class MobiComConversationFragment extends Fragment implements View.OnClickListener {
    ...
    protected  RelativeLayout individualMessageSendLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        individualMessageSendLayout = (RelativeLayout) list.findViewById(R.id.individual_message_send_layout);
        ...
        editTextLinearLayout.setBackground(getResources().getDrawable(R.drawable.rectangle_1));
        ...
        sendButton = (ImageView) individualMessageSendLayout.findViewById(R.id.conversation_send);
                                          ...
                                          public void onClick(View view) {
                                              ...
                                              if (channel != null) {
                                                  ...
                                                  if (contact.isBlocked()) {
                                                      ...
                                                      String userid=MobiComUserPreference.getInstance(getActivity()).getUserId();
                                                      HashMap<String, String> params = new HashMap<>();
                                                      params.put("sender_id",userid);
                                                      params.put("receiver_id",contact.getUserId());
