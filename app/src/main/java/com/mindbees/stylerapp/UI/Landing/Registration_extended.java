...
import com.mindbees.stylerapp.UI.Models.Tribes.Listing;
...
public class Registration_extended extends BaseActivity {
...
//    SpinnerAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initUi();
       otherlinearlayout= (LinearLayout) findViewById(R.id.linearOtherlayout);
...
//        listitems=new ArrayList<SpinnerModel>();
        ...
        {
            String ilike=getPref(Constants.ILIKE);
            ilike="mf";
            if (ilike.equals("m"))
            {
...
//        params.put("gender","m");
//        APIService service = ServiceGenerator.createService(APIService.class, Registration_extended.this);
...
//                if (response.body()!=null&&response.body().getResult()!=null) {
//                    ModelTribes modeltribes = response.body();
//                    List<Result>list1 = modeltribes.getResult();
//                    list.addAll(list1);
////                        gridItems.clear();
...
//
//                    }
//                    adapter=new GridRecycleAdapter(Registration_extended.this,gridItems);
//                    recyclerView.setAdapter(adapter);
//                }
//            }
//
...
//    }
    ...
    private void getTribes(final String value) {
            ...
            if (resultCode==Activity.RESULT_OK)
            {
                try {
                    ...
                    if (edit)
                    {
                        ...
                        Intent intent= new Intent(Registration_extended.this,PopUpAddTribe.class);
...
//               startActivity(intent);
                ...
                for (int i=0;i<gridItems.size();i++)
                {
                    ...
                    {String ilike=getPref(Constants.ILIKE);
                        ...
                        if (ilike.equals("mf"))
                        {
                            builder.append(list3.get(i).getTribeId());
                            builder.append(",");
                        }
                    }
                }
...
//                                .into(image_enlarged);
                        Picasso.with(Registration_extended.this).load(gridItems.get(position).getTribeImage()).into(image_enlarged);
                        ...
                        Intent intent=new Intent(Registration_extended.this,PopupdeleteTribe.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        intent.putExtra("position",position);
...
//            progressDialog.show();
            ...
            final APIService service = ServiceGenerator.createService(APIService.class, Registration_extended.this);
...
//                        progressDialog.dismiss();
                        if (response.body()!=null&&response.body().getResult()!=null){
                            ...
                            if (value==1)
                            {
                                ...
                                Intent intent=new Intent(Registration_extended.this,Registratiom_3_activity.class);
                                startActivity(intent);
                            }
                            else {
                                String msg=modelUpdateProfile.getResult().getMessage();
...
//                    builder.dismiss();
    ...
    private void initUi() {
        ...
        style.setText("Please select styler tribes you like");
